...
const TRACKS = {
  ...
  level3: { name: "Stage 3 - Swelling Spikes (Juhani Junkala)", file: "music/stage3.ogg", loop: true },
  level4: { name: "Stage 4 - Tether Rotators (Juhani Junkala)", file: "music/action1.ogg", loop: true },
  level5: { name: "Stage 5 - Hunter Drone (Juhani Junkala)", file: "music/stage3.ogg", loop: true },
  level6: { name: "Final Stage - As Fast As You Can (Centurion of War)", file: "music/stage4.ogg", loop: true },
...
export function updateMusicForLevel(level) {
  ...
  else if (level >= 6) playTrack("level6");
}
